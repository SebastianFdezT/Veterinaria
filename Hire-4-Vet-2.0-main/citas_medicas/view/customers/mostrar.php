			...
			<div class="content">
				<div class="page-inner">
					...
					<?php
						...
						$db = $database->open();
						try{	
							$sql = 'SELECT customers.codpaci, customers.dnipa,customers.nombrep,customers.apellidop ,customers.seguro,customers.tele,customers.sexo,customers.email,customers.clave,customers.cargo,customers.estado, customers.fecha_create  FROM customers';
